#coded by blsck hat hacker of iran 
...
def dos():
    try:
        ...
        print("please install time: pip instal  time")
    try:
        import requests
    except:
    ...
    try:
        ...
        print("please install sys: pip install os")
    try:
        import desighn
    except:
        print("there are not desighn file")
    try:
        import information_system
    except:
        print("there are not information_system file")
    try:
        import os
    except:
        print("please install os: pip install os")
    bold = '\033[0m'
    endbold = '\033[0m'
...
#################################################
    while(True):
        try:
            ...
            information_system.information()
            time.sleep(5)
            desighn.banner()      
            ...
            for i in admin_list:
                https = requests.get("https://"+target+'/'+i).status_code
